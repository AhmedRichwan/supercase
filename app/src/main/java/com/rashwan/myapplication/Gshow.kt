    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        GListView.onItemLongClickListener =
            AdapterView.OnItemLongClickListener { p0, p1, p2, p3 ->
                ...
                var view2 = layoutInflater.inflate(R.layout.restorecase, null)
                ...
                view2.et7caseSessionDate.setOnClickListener() {
                  pickDateValidation(view2.et7caseSessionDate)
                    ...
                    //take care this shold be up beside alert dialoge
        ...
        mRef?.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                for (n in p0.children) {
                    ...
                    //  Toast.makeText(application, " "+checkDeleted, Toast.LENGTH_LONG).show()

                    if (checkDeleted.toString() == "1") {
