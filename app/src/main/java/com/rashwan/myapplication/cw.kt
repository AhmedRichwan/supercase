        ...
        GListView.onItemLongClickListener =
            AdapterView.OnItemLongClickListener { p0, p1, p2, p3 ->
              ...
              //  if (casy.IsCaseDeleted==1){ mlayout.background= ContextCompat.getDrawable(this, R.drawable.bk)}
                ...
                view2.et7caseSessionDate.text=tools.epochToStr((casy.caseSessionDate)!!.toLong())
                ...
                view2.updbtn.setOnClickListener {
                    ...
                    var afterUpdate = Casesinfo(
                        ...
                        tools.strToEpoch(view2.et7caseSessionDate.text.toString()).toString(),
...
//                view2.delbtn.setOnClickListener {
//
//                    var casy = sortedList?.get(p2)!!
//                    var childRef = mRef?.child(casy.Id!!)
...
//                }
        ...
        GListView.onItemClickListener =
            AdapterView.OnItemClickListener { parent, view, position, id ->
                var sortedList = mNotelist?.sortedWith(compareBy({ it.caseSessionDate }))?.toList()
                var case: Casesinfo = sortedList?.get(position)!!
                case.caseNum
                case.caseYear
                case.caseCount
                case.caseCountYear
